...
public class SolutionTest {
    ...
    public void test1() {
        ...
        assertEquals(3, sut.validWordsCount(sentence));
    }

    @Test
    public void test2() {
        String sentence = "!this  1-s b8d!";
        assertEquals(0, sut.validWordsCount(sentence));
    }

    @Test
    public void test3() {
        String sentence = "alice and  bob are playing stone-game10";
        assertEquals(5, sut.validWordsCount(sentence));
    }

    @Test
    public void test4() {
        String sentence = "he bought 2 pencils, 3 erasers, and 1  pencil-sharpener.";
        assertEquals(6, sut.validWordsCount(sentence));
    }
    ...
    public void test5() {
        ...
        assertEquals(50, sut.validWordsCount(sentence));
    }
    ...
    public void test6() {
        ...
        assertEquals(49, sut.validWordsCount(sentence));
    }
}